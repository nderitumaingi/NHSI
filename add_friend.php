            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Friends of Hospice Registration</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="friend.php" onsubmit="return validateForm()" name="scompany">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="phonenumber" name="phonenumber" placeholder="Individual phonenumber">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Email</label>
                        <input type="email" class="form-control" id="email"  name="email" placeholder="Individual Email">
                    </div>
                    <div class="form-group">
