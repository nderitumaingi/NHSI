...
<div class="content-wrapper">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Update <?php echo $name;?>'s Information</h3><a href="staff.php" style="float : right" class="btn btn-outline-info"><i class="fas fa-angle-double-left fa-2x"></i></a>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
  ...
  if(isset($_POST['update'])){
    ...
    if($queryupdate){
       echo'<script>window.alert("staff information updated succesifully")</script>';
       header("Location: staff.php");
       } else{
       echo'<script>window.alert("staff information not updated. Please try again.")</script>';
       header('refresh:0;url=updatestaff.php');			
       }
 }
?>
