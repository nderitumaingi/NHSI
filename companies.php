...
<aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    ...
    <a href="add_company.php" class="btn btn-info bt-sm">Add Sponsor company</a>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
...
?>
                  <tr>
                    ...
                    <?php echo"<td> <a href='viewcompany.php?id=".$row['id']."' class='btn btn-success'>VIEW</a></td>";?>
                    <?php echo"<td> <a href='updatecompany.php?id=".$row['id']."'class='btn btn-primary'>UPDATE</a></td>"?>
                    <?php echo"<td> <a href='deletecompany.php?id=".$row['id']."'class='btn btn-danger'>DELETE</a></td>"?>
                  </tr>
               <?php } ?>
