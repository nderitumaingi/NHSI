...
<aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    ...
    <a href="add_staff.php" class="btn btn-info bt-sm">Add Staff Member</a>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
...
?>
                  <tr>
                    ...
                    <?php echo"<td> <a href='viewstaff.php?id=".$row['id']."' class='btn btn-success'>VIEW</a></td>";?>
                    <?php echo"<td> <a href='updatestaff.php?id=".$row['id']."'class='btn btn-primary'>UPDATE</a></td>"?>
                    <?php echo"<td> <a href='deletestaff.php?id=".$row['id']."'class='btn btn-danger'>DELETE</a></td>"?>
                  </tr>
               <?php } ?>
